...
const testTypeChartOptions = computed((): ApexOptions => {
...
const weeklyChartOptions = computed((): ApexOptions => ({
  chart: {
    type: 'area' as const,
    height: 320,
    background: 'transparent',
    ...
    <template v-else>
      ...
      <div class="grid grid-cols-4 gap-4">
        <div class="bg-white dark:bg-dark-bg-secondary border border-slate-500 dark:border-dark-border-primary p-6">
          <p class="text-xs font-mono text-slate-500 dark:text-slate-400 uppercase tracking-wider">{{ t('analytics.totalTests') }}</p>
        ...
        <div class="bg-white dark:bg-dark-bg-secondary border border-slate-500 dark:border-dark-border-primary p-6">
          <p class="text-xs font-mono text-slate-500 dark:text-slate-400 uppercase tracking-wider">{{ t('analytics.successRate') }}</p>
        ...
        <div class="bg-white dark:bg-dark-bg-secondary border border-slate-500 dark:border-dark-border-primary p-6">
          <p class="text-xs font-mono text-slate-500 dark:text-slate-400 uppercase tracking-wider">{{ t('analytics.avgResponse') }}</p>
        ...
        <div class="bg-white dark:bg-dark-bg-secondary border border-slate-500 dark:border-dark-border-primary p-6">
          <p class="text-xs font-mono text-slate-500 dark:text-slate-400 uppercase tracking-wider">{{ t('analytics.thisWeek') }}</p>
      ...
      <div class="grid grid-cols-3 gap-4">
        ...
        <div class="bg-white dark:bg-dark-bg-secondary border border-slate-500 dark:border-dark-border-primary">
          <div class="border-b border-slate-500 dark:border-dark-border-primary px-6 py-3">
            <h2 class="text-xs font-mono font-semibold text-slate-900 dark:text-slate-100 uppercase tracking-wider">{{ t('analytics.testTypeDistribution') }}</h2>
          </div>
          <div class="p-6">
            <VueApexCharts
              type="pie"
        ...
        <div class="bg-white dark:bg-dark-bg-secondary border border-slate-500 dark:border-dark-border-primary">
          <div class="border-b border-slate-500 dark:border-dark-border-primary px-6 py-3">
            <h2 class="text-xs font-mono font-semibold text-slate-900 dark:text-slate-100 uppercase tracking-wider">{{ t('analytics.testStatus') }}</h2>
          </div>
          <div class="p-6">
            <VueApexCharts
              type="donut"
        ...
        <div class="bg-white dark:bg-dark-bg-secondary border border-slate-500 dark:border-dark-border-primary">
          <div class="border-b border-slate-500 dark:border-dark-border-primary px-6 py-3">
            <h2 class="text-xs font-mono font-semibold text-slate-900 dark:text-slate-100 uppercase tracking-wider">{{ t('analytics.weeklyActivity') }}</h2>
          </div>
          <div class="p-6">
            <VueApexCharts
              type="area"
      ...
      <div class="bg-white dark:bg-dark-bg-secondary border border-slate-500 dark:border-dark-border-primary">
        <div class="border-b border-slate-500 dark:border-dark-border-primary px-6 py-3">
          <h2 class="text-xs font-mono font-semibold text-slate-900 dark:text-slate-100 uppercase tracking-wider">{{ t('analytics.performanceInsights') }}</h2>
        </div>
        <div class="p-6 space-y-3">
          <div class="flex items-start space-x-3 p-3 bg-accent-success/10 dark:bg-accent-success/20 border border-accent-success/20">
            ...
            <div class="flex-1">
              <p class="text-sm font-medium text-slate-900 dark:text-slate-100">{{ t('analytics.improvements.responseTime') }}</p>
              <p class="mt-1 text-xs text-slate-600 dark:text-slate-400 font-mono">{{ t('analytics.improvements.responseTimeDesc') }}</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-3 p-3 bg-accent-info/10 dark:bg-accent-info/20 border border-accent-info/20">
            ...
            <div class="flex-1">
              <p class="text-sm font-medium text-slate-900 dark:text-slate-100">{{ t('analytics.improvements.highFrequency') }}</p>
              <p class="mt-1 text-xs text-slate-600 dark:text-slate-400 font-mono">{{ t('analytics.improvements.highFrequencyDesc') }}</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-3 p-3 bg-accent-warning/10 dark:bg-accent-warning/20 border border-accent-warning/20">
            ...
            <div class="flex-1">
              <p class="text-sm font-medium text-slate-900 dark:text-slate-100">{{ t('analytics.improvements.attention') }}</p>
              <p class="mt-1 text-xs text-slate-600 dark:text-slate-400 font-mono">{{ t('analytics.improvements.attentionDesc') }}</p>
            </div>
          </div>
        </div>
      </div>
